...
class BaseModel(nn.Module):
    ...
    def _get_same_hf_param(
        ...
        for param, load_spec in params:
            ...
            if load_spec.hf_keys[0] == "lm_head.weight" or "mlp.gate.weight" in load_spec.hf_keys[0]:
                # logger.info(f"handling same hf param separately: {load_spec.hf_keys}")
                ...
                local_tensor = local_tensor.bfloat16()  # to(dtype)
                tensor_size = self._get_tensor_size(param, dtype)
